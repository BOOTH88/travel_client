...
@app.route('/<username>/food/share')
def food_release(username):
    #发表博客
    return send_file('templates/share.html')

@app.route('/<username>/foods')
def foods(username):
    #个人博客列表
    return send_file('templates/food.html')
